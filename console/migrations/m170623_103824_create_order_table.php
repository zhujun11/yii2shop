 ...
 */
class m170623_103824_create_order_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        $this->createTable('order', [
            ...
            'city'=>$this->string(20)->comment('省'),
            'area'=>$this->string(20)->comment('省'),
            ...
            'payment_id'=>$this->integer()->comment('支付方式'),
            'payment_name'=>$this->string()->comment('支付名称'),
            'total'=>$this->decimal()->comment('订单金额'),
            'status'=>$this->integer()->comment('订单状态(0已取消1待支付2代发货3待收货4完成)'),
