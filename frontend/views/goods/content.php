...
<div class="main w1210 mt10 bc">
    ...
    <div class="breadcrumb">
        <h2>当前位置：
            <?=\yii\helpers\Html::a('首页',['home/index'])?> >
            <?=\yii\helpers\Html::a($goods->goodsCategory->parent->name,['goods/secondList'])?> >                             <?=\yii\helpers\Html::a($goods->goodsCategory->name,['goods/index','id'=>$goods->goods_category_id])?> >
            <?=$goods->name?>
        </h2>
    </div>
    <!-- 面包屑导航 end -->
    ...
    <div class="goods_left fl">
        ...
        <div class="related_cat leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <ul>
                    <?php foreach (\backend\models\GoodsCategory::find()->where(['parent_id'=>$goods->goodsCategory->parent_id])->all() as $category):?>
                        <li><?=\yii\helpers\Html::a($category->name,['goods/index','id'=>$category->id])?></li>
                    <?php endforeach;?>
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    ...
                    <div class="desc mt10">
                        ...
                        <?php foreach (\backend\models\GoodsImg::find()->where(['goods_id'=>$goods->id])->all() as $img):?>
                        <img src="<?='http://admin.yii2shop.com'.$img->url?>" alt="" />
