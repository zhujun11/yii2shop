...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        <h1 class="fl"><a href="/home/index.html"><?=Html::img('@web/images/logo.png')?></a></h1>
        <!-- 头部搜索 start -->
        <div class="search fl">
            ...
            <dl>
                ...
                <dd>
                    <div class="prompt">
                        <?php
                        if (Yii::$app->user->id){
                            $count=\frontend\models\Cart::find()->where(['member_id'=>Yii::$app->user->id])->count();
                            if ($count){
                                echo '您有 :'.$count.' 条购物记录待结算';
                            }else{
                                echo '您购物车还没有商品,快去购物吧';
                            }
