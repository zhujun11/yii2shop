...
<div class="login w990 bc mt10">
    ...
    <div class="login_bd">
        <div class="login_form fl">
            <?php
                ...
                echo $form->field($model,'catpCode',['options'=>['class'=>'checkcode']])->widget(yii\captcha\Captcha::className(),[
                    'template'=>'{input}{image}看不清?点击图片刷新',
                ]);
                echo $form->field($model,'remember',['template'=>"{label}\n{input} 保存登录信息",])->checkbox(['class'=>'chb'],false)->label('&nbsp;');
            echo '<li>
                        <label for="">&nbsp;</label>
        ...
        <div class="guide fl">
            ...
            <a href="/regist/regist.html" class="reg_btn">免费注册 >></a>
        </div>
